    ...
    <>
      <div className="flex flex-col gap-5 overflow-y-auto max-h-72">
            ...
            <CardContent className="flex justify-between">
              <div>
                ...
                <p className="font-semibold">
                  Facture #{invoice.details.invoiceNumber}{" "}
                </p>
                <small className="text-gray-500">
                  Modifié le: {invoice.details.updatedAt}
                </small>

                <div>
                  <p>Expéditeur: {invoice.sender.name}</p>
                  <p>Destinataire: {invoice.receiver.name}</p>
                  <p>
                    Totale:{" "}
        ...
        {savedInvoices.length == 0 && (
          <div>
            <p>Pas de factures sauvegardées</p>
          </div>
        )}
      </div>
    </>
