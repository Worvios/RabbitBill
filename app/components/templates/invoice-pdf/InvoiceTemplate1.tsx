  ...
  return (
    <InvoiceLayout data={data}>
      ...
      <div>
        <div className="my-4">
          <div className="my-2">
            <p className="font-semibold text-blue-600">Notes suplémentaires:</p>
          ...
          <div className="my-2">
            <span className="font-semibold text-md text-gray-800">
              ...
              <p className="text-sm">
                Numéro de compte: {details.paymentInformation?.accountNumber}
              </p>
            </span>
          </div>
        </div>
        <p className="text-gray-500 text-sm">
          Si vous avez des questions concernant cette facture, veuillez utiliser
